...
import logo from "../../static/img/avataar/ghoul.jpg";
import noise from "../../static/img/avataar/noise.png";
    ...
    return (
        <header className={clsx(styles.heroBanner)}>
            <div className="container">
                ...
                <canvas width="300" height="300" style={{ borderRadius: '10%' }} />
                <h1 className="hero__title">{siteConfig.title}</h1>
                <p className="hero__subtitle">{siteConfig.tagline}</p>
                <div className={styles.buttons}>
                    <Link className="button button--secondary button--lg" to="docs/consultancy">
                        Consultancy →
                    </Link>
                </div>
            </div>
